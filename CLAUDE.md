...
- **The "Book Now" popup is intentionally deferred.** Don't add it unless the user explicitly asks. The chat that produced this plugin gated it explicitly: "Wait to add this feature until 1) we complete making the widget and 2) I tell you to add it."
